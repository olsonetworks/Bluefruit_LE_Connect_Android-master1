...
void loop(void)
{
 /* This section allows for use of SPST joysticks  I have two connected to the mech.  Pushing forward or reverse controls each motor respectively.  
    We use the input pullups on the digital pins to read HIGH or LOW.  Assign different pins depending on how you connect them to your arduino.  
    NOTE:  These read HIGH when not in position, so we are checking for LOW to make the motors move*/
